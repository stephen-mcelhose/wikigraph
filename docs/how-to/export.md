...
- `pi` — stationary probability (centrality): how often a random walker visits this page (see [[how-to/graph]] for a visual explanation)
- `class` — communicating class index (`-1` means the page is transient / isolated; see [[how-to/analyze]] for what classes mean)
